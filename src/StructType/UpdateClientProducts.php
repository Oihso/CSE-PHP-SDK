...
/**
 * This class stands for UpdateClientProducts StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class UpdateClientProducts extends AbstractStructBase
{
    /**
     * The data
    ...
    /**
     * Constructor method for UpdateClientProducts
     * @uses UpdateClientProducts::setData()
     * @uses UpdateClientProducts::setLogin()
     * @uses UpdateClientProducts::setPassword()
     * @uses UpdateClientProducts::setParameters()
     ...
     * Set data value
     * @param \Oihso\CSESDK\StructType\Element $data
     * @return \Oihso\CSESDK\StructType\UpdateClientProducts
     */
