...
class GetDocuments extends AbstractStructBase
{
    /**
     * The login
     ...
     * @uses GetDocuments::setLogin()
     * @uses GetDocuments::setPassword()
     * @uses GetDocuments::setData()
     * @uses GetDocuments::setParameters()
     * @param string $login
     * @param string $password
     * @param \Oihso\CSESDK\StructType\Element $data
     * @param \Oihso\CSESDK\StructType\Element $parameters
     */
    public function __construct(?string $login = null, ?string $password = null, ?\Oihso\CSESDK\StructType\Element $data = null, ?\Oihso\CSESDK\StructType\Element $parameters = null)
    {
        $this
            ->setLogin($login)
     ...
     * Set login value
     * @param string $login
     * @return \Oihso\CSESDK\StructType\GetDocuments
     */
