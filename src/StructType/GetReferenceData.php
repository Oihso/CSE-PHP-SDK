...
/**
 * This class stands for GetReferenceData StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetReferenceData extends AbstractStructBase
{
    /**
     * The parameters
    ...
    /**
     * Constructor method for GetReferenceData
     * @uses GetReferenceData::setParameters()
     * @uses GetReferenceData::setLogin()
     * @uses GetReferenceData::setPassword()
     ...
     * @param \Oihso\CSESDK\StructType\Element $parameters
     * @return \Oihso\CSESDK\StructType\GetReferenceData
     */
