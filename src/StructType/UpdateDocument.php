...
/**
 * This class stands for UpdateDocument StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class UpdateDocument extends AbstractStructBase
{
    /**
     * The data
     ...
     * @uses UpdateDocument::setData()
     * @uses UpdateDocument::setLogin()
     * @uses UpdateDocument::setPassword()
     * @uses UpdateDocument::setParameters()
     ...
     * Set data value
     * @param \Oihso\CSESDK\StructType\Element $data
     * @return \Oihso\CSESDK\StructType\UpdateDocument
     */
