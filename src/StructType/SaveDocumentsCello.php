...
/**
 * This class stands for SaveDocumentsCello StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SaveDocumentsCello extends AbstractStructBase
{
    /**
     * The login
    ...
    /**
     * Constructor method for SaveDocumentsCello
     * @uses SaveDocumentsCello::setLogin()
     * @uses SaveDocumentsCello::setPassword()
     * @uses SaveDocumentsCello::setData()
     * @uses SaveDocumentsCello::setParameters()
