...
/**
 * This class stands for CreateGMHResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class CreateGMHResponse extends AbstractStructBase
{
    /**
     * The return
    ...
    /**
     * Constructor method for CreateGMHResponse
     * @uses CreateGMHResponse::setReturn()
