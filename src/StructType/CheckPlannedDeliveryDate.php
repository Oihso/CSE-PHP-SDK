...
/**
 * This class stands for CheckPlannedDeliveryDate StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class CheckPlannedDeliveryDate extends AbstractStructBase
{
    /**
     * The data
    ...
    /**
     * Constructor method for CheckPlannedDeliveryDate
     * @uses CheckPlannedDeliveryDate::setData()
     * @uses CheckPlannedDeliveryDate::setLogin()
     * @uses CheckPlannedDeliveryDate::setPassword()
     * @uses CheckPlannedDeliveryDate::setParameters()
     ...
     * Set data value
     * @param \Oihso\CSESDK\StructType\Element $data
     * @return \Oihso\CSESDK\StructType\CheckPlannedDeliveryDate
     */
